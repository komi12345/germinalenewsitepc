...
export const mockCollections: Collection[] = [
  {
    ...
    description: "Redécouvrez les chefs-d'œuvre intemporels qui ont façonné notre imaginaire collectif.",
  ...
  },
  {
    ...
    description: "Des vers modernes qui capturent l'essence de notre époque avec sensibilité.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    description: "Comprendre le passé pour mieux appréhender les défis du présent.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    description: "Explorez des mondes futuristes et des réalités alternatives captivantes.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    name: "Biographies",
    slug: "biographies",
    description: "Les parcours de vie extraordinaires de ceux qui ont changé le monde.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    name: "Philosophie",
    slug: "philosophie",
    description: "Les grandes questions de l'existence explorées par les plus grands penseurs.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    description: "Les pièces majeures du théâtre africain contemporain et classique.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    description: "Les récits traditionnels qui ont bercé des générations entières.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    description: "Des ouvrages pour grandir, s'épanouir et atteindre vos objectifs.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    name: "Art & Culture",
    slug: "art-culture",
    description: "Explorez les richesses artistiques et culturelles du monde francophone.",
    coverImage: "/images/placeholder-collection.svg",
  ...
  },
  {
    ...
    name: "Jeunesse",
    slug: "jeunesse",
    description: "Des histoires captivantes pour éveiller l'imagination des plus jeunes.",
    coverImage: "/images/placeholder-collection.svg",
...
export const mockCollectionsWithBooks: CollectionWithBooks[] = [
  {
    ...
    name: "Littérature Classique",
    slug: "litterature-classique",
    description: "Redécouvrez les chefs-d'œuvre intemporels qui ont façonné notre imaginaire collectif. Cette collection rassemble les plus grands classiques de la littérature francophone, des œuvres qui traversent les époques et continuent de nous émouvoir par leur profondeur et leur beauté.",
    coverImage: "/images/placeholder-collection.svg",
    price: 5000,
    originalPrice: 6500,
    discountPercent: 23,
  ...
  },
  {
    ...
    name: "Poésie Contemporaine",
    slug: "poesie-contemporaine",
    description: "Des vers modernes qui capturent l'essence de notre époque avec sensibilité. Cette collection réunit les voix poétiques les plus marquantes de notre temps, offrant un panorama riche et émouvant de la création poétique contemporaine.",
    coverImage: "/images/placeholder-collection.svg",
    price: 3500,
    bookCount: 3,
  ...
  },
  {
    ...
    name: "Histoire & Essais",
    slug: "histoire-essais",
    description: "Comprendre le passé pour mieux appréhender les défis du présent. Cette collection propose des ouvrages essentiels pour éclairer notre compréhension du monde, mêlant rigueur historique et réflexions contemporaines.",
    coverImage: "/images/placeholder-collection.svg",
    price: 6000,
    originalPrice: 7500,
    discountPercent: 20,
  ...
  },
  {
    ...
    name: "Romans Policiers",
    slug: "romans-policiers",
    description: "Intrigues, mystères et enquêtes haletantes pour vos soirées. Plongez dans des récits captivants où suspense et rebondissements vous tiendront en haleine jusqu'à la dernière page.",
    coverImage: "/images/placeholder-collection.svg",
    price: 4500,
    bookCount: 4,
    isNew: true,
  ...
  },
  {
    ...
    name: "Science-Fiction",
    slug: "science-fiction",
    description: "Explorez des mondes futuristes et des réalités alternatives captivantes. Cette collection vous emmène aux confins de l'imagination, là où la science rencontre la fiction pour créer des univers extraordinaires.",
    coverImage: "/images/placeholder-collection.svg",
    price: 4800,
    bookCount: 3,
    isPopular: true,
  ...
  },
  {
    ...
    name: "Biographies",
    slug: "biographies",
    description: "Les parcours de vie extraordinaires de ceux qui ont changé le monde. Découvrez les destins fascinants de personnalités qui ont marqué l'histoire par leur courage, leur vision et leur détermination.",
    coverImage: "/images/placeholder-collection.svg",
    price: 5500,
    bookCount: 3,
  ...
  },
  {
    ...
    name: "Philosophie",
    slug: "philosophie",
    description: "Les grandes questions de l'existence explorées par les plus grands penseurs. Une collection pour nourrir votre réflexion et approfondir votre compréhension des enjeux fondamentaux de la condition humaine.",
    coverImage: "/images/placeholder-collection.svg",
    price: 7000,
    originalPrice: 8500,
    discountPercent: 18,
  ...
  },
  {
    ...
    name: "Théâtre Africain",
    slug: "theatre-africain",
    description: "Les pièces majeures du théâtre africain contemporain et classique. Une collection qui célèbre la richesse dramatique du continent, des œuvres qui font entendre des voix puissantes et authentiques.",
    coverImage: "/images/placeholder-collection.svg",
    price: 4000,
    bookCount: 3,
    isNew: true,
  ...
  },
  {
    ...
    name: "Contes & Légendes",
    slug: "contes-legendes",
    description: "Les récits traditionnels qui ont bercé des générations entières. Redécouvrez la magie des contes ancestraux, porteurs de sagesse et d'émerveillement, transmis de génération en génération.",
    coverImage: "/images/placeholder-collection.svg",
    price: 3000,
    bookCount: 4,
    isPopular: true,
  ...
  },
  {
    ...
    name: "Développement Personnel",
    slug: "developpement-personnel",
    description: "Des ouvrages pour grandir, s'épanouir et atteindre vos objectifs. Cette collection vous accompagne dans votre parcours de développement personnel avec des conseils pratiques et inspirants.",
    coverImage: "/images/placeholder-collection.svg",
    price: 5200,
    bookCount: 3,
  ...
  },
  {
    ...
    name: "Art & Culture",
    slug: "art-culture",
    description: "Explorez les richesses artistiques et culturelles du monde francophone. Une collection qui célèbre la diversité créative et le patrimoine culturel à travers des ouvrages richement illustrés.",
    coverImage: "/images/placeholder-collection.svg",
    price: 6500,
    bookCount: 3,
  ...
  },
  {
    ...
    name: "Jeunesse",
    slug: "jeunesse",
    description: "Des histoires captivantes pour éveiller l'imagination des plus jeunes. Cette collection propose des récits adaptés aux jeunes lecteurs, alliant aventure, humour et valeurs positives.",
    coverImage: "/images/placeholder-collection.svg",
    price: 2500,
    bookCount: 4,
    isNew: true,
 ...
 */
export function getCollectionBySlug(slug: string): CollectionWithBooks | undefined {
 ...
 */
export function getRelatedCollections(currentSlug: string): CollectionWithBooks[] {
