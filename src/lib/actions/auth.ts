...
export async function signIn(formData: FormData) {
  ...
  try {
    ...
    console.error('[auth.signIn] Erreur interne lors de la connexion', error);
    return {
      error:
...
export async function signUp(formData: FormData) {
  ...
  try {
    ...
    return {
      error:
        'Erreur interne lors de la création du compte. Veuillez réessayer plus tard.',
    };
  }
}
...
export async function signOut() {
  try {
    ...
    return {
      error:
        'Erreur interne lors de la déconnexion. Veuillez réessayer plus tard.',
    };
  }
}
