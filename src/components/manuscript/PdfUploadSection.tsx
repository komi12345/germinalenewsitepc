  ...
  return (
    <div className="space-y-4" data-testid="pdf-upload-section">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gold">Fichier PDF</h2>
      </div>
      ...
      <div
        ...
        className={cn(
          ...
          !isDragging &&
            !displayError &&
            'border-dark-lighter bg-dark hover:border-gold hover:bg-gold/5',
          // État drag actif
      ...
      >
        ...
        {file ? (
          ...
          <>
            ...
            {/* Texte principal */}
            <p
              className="text-base font-semibold text-light mb-1"
              data-testid="drop-text-main"
            >
            ...
            {/* Texte secondaire */}
            <p
              className="text-sm text-light-dimmed mb-3"
              data-testid="drop-text-secondary"
            >
            ...
            <p
              className="text-xs text-light-dimmed"
              data-testid="file-constraints"
            >
