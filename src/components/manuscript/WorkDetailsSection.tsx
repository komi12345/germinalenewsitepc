...
import { ManuscriptFormData, LITERARY_GENRES, countWords, VALIDATION_CONSTANTS } from "../../lib/validations/manuscript";
 ...
 */
export function WorkDetailsSection({ register, errors, control }: WorkDetailsSectionProps) {
    ...
    <div className="space-y-4" data-testid="work-details-section">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          >
            <option value="" className="bg-dark text-light-dimmed">Sélectionner un genre</option>
            {LITERARY_GENRES.map((genre) => (
              <option key={genre.value} value={genre.value} className="bg-dark text-light">
                {genre.label}
              </option>
            ))}
          </select>
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="text-sm text-light-dimmed" data-testid="max-words-label">
              Max 500 mots
            </span>
          </div>
          <textarea
