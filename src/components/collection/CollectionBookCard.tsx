  ...
  return (
    <div className="group" data-testid="collection-book-card">
      ...
      <div className="mt-3">
        {/* Titre du livre */}
        <h3
          className={cn('font-medium', 'text-gold', 'line-clamp-2')}
        ...
        {/* Nom de l'auteur */}
        <p className="text-sm text-light-dimmed mt-1" data-testid="book-author">
          {book.author}
        </p>

        {/* Prix et lien Acheter seul */}
        <div className="flex items-center justify-between mt-2">
          <span className="font-medium text-light" data-testid="book-price">
