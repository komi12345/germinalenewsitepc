  ...
  it('should always display exactly 3 steps with icons, titles, and descriptions', () => {
    fc.assert(
      fc.property(fc.constant(null), () => {
        ...
        const section = container.querySelector('[data-testid="how-it-works-section"]');
        expect(section).not.toBeNull();

        // Verify exactly 3 steps are displayed (Requirement 5.3)
        const stepsContainer = container.querySelector('[data-testid="steps-container"]');
        ...
        const titles = Array.from(container.querySelectorAll('[data-testid^="step-"] h3'))
