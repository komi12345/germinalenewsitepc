  ...
  describe('ArticleCard Component', () => {
    it('should display cover image with descriptive alt text', () => {
      ...
      expect(images[0]).toHaveAttribute(
        'alt',
        "Image de couverture de l'article: Test Article One"
      );
    });
    ...
    it('should display article excerpts', () => {
      ...
      expect(
        screen.getByText('This is the excerpt for the first test article.')
      ).toBeInTheDocument();
      expect(
        screen.getByText('This is the excerpt for the second test article.')
      ).toBeInTheDocument();
      expect(
        screen.getByText('This is the excerpt for the third test article.')
      ).toBeInTheDocument();
    });
  ...
  describe('AuthorInfo Component', () => {
    ...
    it('should display avatar image when provided', () => {
      ...
      const avatarImages = container.querySelectorAll(
        'img[alt="JOHN DOE"], img[alt="JANE SMITH"]'
      );
    ...
    it('should display "EG" initials for "ÉDITIONS GERMINALE" author', () => {
      ...
      const { container } = render(
        <BlogSection articles={articlesWithEditionsGerminale} />
      );
    ...
    it('should generate correct initials for two-word names', () => {
      ...
      const { container } = render(
        <BlogSection articles={articlesWithTwoWordName} />
      );
