          ...
          <div className="space-y-6">
            ...
            <blockquote className="border-l-4 border-gold pl-6 py-2">
              <p className="text-light-muted text-lg md:text-xl italic leading-relaxed">
                ...
                . Notre maison d&apos;édition numérique incarne l&apos;alliance
                parfaite entre l&apos;élégance littéraire traditionnelle et
            ...
            <div className="space-y-4 text-light-dimmed leading-relaxed">
              <p>
                Nous croyons en une édition chaleureuse, accessible et
                résolument tournée vers l&apos;avenir, offrant à chaque auteur
                et lecteur une expérience unique. Dans un monde où le numérique
                peut parfois sembler froid, nous nous efforçons de remettre
                l&apos;humain au cœur de chaque interaction, de chaque page
                tournée, qu&apos;elle soit de papier ou de pixels.
              </p>
              <p>
                Notre mission est de dénicher les voix singulières qui
                façonneront la littérature de demain. Nous ne nous contentons
                pas de publier des livres ; nous cultivons des imaginaires, nous
                faisons germer des idées. Chaque ouvrage qui rejoint notre
                catalogue est une promesse tenue envers la qualité et
                l&apos;authenticité.
              </p>
              <p>
                C&apos;est avec une immense fierté et un enthousiasme renouvelé
                que je vous invite à parcourir notre catalogue et à découvrir
                notre univers, où chaque mot compte et chaque histoire résonne.
              </p>
            </div>
