...
export function AuthorCTASection() {
  return (
    <section
      className={cn('py-12 md:py-16 px-4', 'bg-dark-light')}
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Éditions Germinale accompagne les auteurs africains dans la
          publication de leurs œuvres. Partagez votre talent avec le monde et
          rejoignez notre communauté d&apos;écrivains passionnés.
        </p>
