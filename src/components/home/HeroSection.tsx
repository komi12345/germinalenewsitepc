  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          Découvrez notre maison d&apos;édition dédiée aux voix africaines. Des
          histoires authentiques, des auteurs passionnés, une littérature qui
          célèbre notre richesse culturelle.
        </p>
